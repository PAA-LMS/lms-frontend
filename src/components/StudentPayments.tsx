                        ...
                        >
                          ...
                          >
                            {submission.status === 'verified' ? 
                              <CheckCircleIcon fontSize="small" color="success" sx={{ mr: 0.5, fontSize: '1.1rem' }} /> : 
                              submission.status === 'rejected' ?
                              <CancelIcon fontSize="small" color="error" sx={{ mr: 0.5, fontSize: '1.1rem' }} /> :
                              <HourglassEmptyIcon fontSize="small" color="warning" sx={{ mr: 0.5, fontSize: '1.1rem' }} />
                            }
                            Feedback
                          </Typography>
                          <Paper
                ...
                <Box mt={3}>
                  ...
                  >
                    {selectedSubmission.status === 'verified' ? 
                      <CheckCircleIcon fontSize="small" color="success" sx={{ mr: 1, fontSize: '1.1rem' }} /> : 
                      selectedSubmission.status === 'rejected' ?
                      <CancelIcon fontSize="small" color="error" sx={{ mr: 1, fontSize: '1.1rem' }} /> :
                      <HourglassEmptyIcon fontSize="small" color="warning" sx={{ mr: 1, fontSize: '1.1rem' }} />
                    }
                    Verification Notes
                  </Typography>
                  <Paper 
